  ...
  return (
    <>
      ...
      <nav className={activeContentSubmenu ? "navInAction" : ""}>
        <Link to="/"><img id="GameIcon" src={require('../../../images/LogoProjectD.png')} alt="LogoIcon" /></Link>
        <div className="LinksGroup">
          <div className="leftSide">
            ...
            <Link to="/News">
              <div id="newsId" className={`LinkButtonContainer ${activeNewsSubmenu ? "LinkButtonContainerInAction" : ""}`}>
                <div className="linkButton">
                  News
                </div>
                <Floater styles={{
                  ...
                  <div className={`submenuButton ${activeNewsSubmenu ? "submenuButtonInAction" : ""}`} onMouseEnter={() => setActiveNewsSubmenu(true)} onMouseLeave={() => setActiveNewsSubmenu(false)}>
                    <div className={`Arrow ${activeNewsSubmenu ? "ArrowInAction" : ""}`}>▾</div>
                  </div>
                </Floater>
              </div>
            </Link>
