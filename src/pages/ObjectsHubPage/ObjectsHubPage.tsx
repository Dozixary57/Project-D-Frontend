...
import { selectFilteredObjects } from "@ReduxStore/Reducers/objects/selectFilteredObjects";
import { setFilterParamsList, setFilterTitleQuery, setIsFilterByCategory, setObjectsData } from "@ReduxStore/Reducers/objects/objectsFilteredResult";
...
const ObjectsHubPage = () => {
  ...
  useEffect(() => {
    ...
    dispatch(setIsFilterByCategory(true));
    dispatch(setFilterTitleQuery(''));
    dispatch(setFilterParamsList({'ID': 2 }));
  }, []);
  ...
  useEffect(() => {
    ...
    console.log(filteredObjects && filteredObjects.length > 0)
  }, [filteredObjects]);
